          ...
          <div className='sm:text-right pb-8 pl-4 flex flex-col justify-end'>
            <p className='text-4xl font-bold inline '>
              <a
                ...
                className='border-b-4 border-[#FFD369]'
              >
                YouTube
              </a>
            </p>
          ...
          <div className='flex flex-col justify-start px-5 2xl:text-lg border-4 rounded-2xl p-5 text-justify'>
            ...
            <div className=''>
              <p>
                ...
                diváka dostal s sebou k vodě a užil si tento zážitek společně se
                mnou.
              </p>
            </div>
          </div>
          ...
          <div className='flex flex-col justify-start px-5 2xl:text-lg border-4 rounded-2xl p-5 text-justify'>
            ...
            <div>
              <p>
                ...
                <a
                  href='https://www.youtube.com/channel/UCZ3J43l2QzHVkKYBfaoPAcQ/join'
                  className='font-bold border-b-2 border-[#FFD369]'
                >
                  zde...
                </a>
              </p>

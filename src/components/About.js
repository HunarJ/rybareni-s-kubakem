          ...
          <div className="max-w-[1200px] w-full grid md:grid-cols-2 gap-8 px-4 my-3">
            ...
            <div className="flex flex-col justify-center px-5 2xl:text-lg border-8 rounded-2xl p-5 text-justify">
              <p>
                ...
                workshop. Rybaření mě pohltilo natolik, že se z koníčku stal
                spíše životní styl...
              </p>
            </div>
          </div>
          <div className="max-w-[1200px] w-full grid md:grid-cols-2 gap-8 px-4 my-10">
            <div className="flex flex-col justify-center px-5 2xl:text-lg border-8 rounded-2xl p-5 text-justify">
              <p>
                ...
                plavané. Postupem času jsem se zdokonaloval díky přátelům, ale
                ten největší posun jsem zaznamenal, když jsem začal natáčet
                videa na sociální sítě a následně na Youtube. Komunita fanoušků
                a přátel mě posunula mílovými kroky kupředu. Každým komentářem
                jsem se zdokonaloval i v praxi. Rady jsem si bral k srdci a u
                vody je testoval a testoval. Krok za krokem jsem si vytvářel
                nové funkční postupy, a ty mi časem přinesly velké úlovky a

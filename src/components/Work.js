            ...
            <div className="h-auto px-5">
              ...
              <div className="border-8 rounded-2xl p-5 text-justify">
                ...
                <p className="my-5">
                  ...
                  - budou vyrábět právě oni. V celém sortimentu naleznete - 1kg
                  a 3kg balení „krmných koulí“ , chytací koule v jejich stylu
                  „Silent hunter“, obalované pop-up, obalovací těsto, booster a
                  další…
                </p>
                <p className="my-5">
                  Zakoupení těchto výrobků mě osobně podpoříš v tom co rád dělám
                  a to je točení videjí na mém{" "}
                  <a
                    href="https://www.youtube.com/@RybarenisKubakem"
                    className="font-bold hover:text-[#FFD369] link--resized"
                  >
                  ...
                  a hlavně můžeš chytat na kvalitní koule co jsem dal dohromady
                  s{" "}
                  <a
                    href="https://www.tactics.cz/"
                    className="font-bold hover:text-[#FFD369] link--resized"
                ...
                <div className="flex flex-col justify-center items-center">
                  ...
                  <a href="https://www.tactics.cz/kubakuv-program/" className="link--resized">

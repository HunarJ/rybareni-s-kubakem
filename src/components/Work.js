        ...
        <div className="max-w-[1200px] w-full grid md:grid-cols-2 gap-8 px-4 my-3">
          ...
          <div className="flex flex-col justify-center px-5 2xl:text-lg text-justify 2xl:border-8 rounded-2xl p-5 text-justify">
            <p>
              ...
              revírech, typování míst k rybaření, produktové poradenství,
              workshopy a rybaření na malém soukromém revíru v Orlických Horách.
            </p>
          </div>
          ...
          <div className="h-auto px-5">
            ...
            <div className="2xl:border-8 rounded-2xl p-5 text-justify">
              ...
              <p className="my-5">
                ...
                jsme se seznámili na For Fishing 2023, kde jsem na ně narazil
                poprvé na jejich stánku. Nejdříve mě zajímal jejich produkt z
                kontroverzním názvem{" "}
                <a
                ...
                . Dostal jsem vzorek a po dalším zjišťování a testování jejich
                produktů jako je{" "}
                <a
                ...
                výrobky jak fungují ve vodě a hlavně mi vyhovují jejich produkty
                jako takové. Na{" "}
                <a
                  href="https://www.tactics.cz/stitek-produktu/cervene-ovoce/"
                  className="font-bold hover:text-[#FFD369]"
              ...
              <p className="my-5">
                ...
                přístup jak jejich produkty vyrábějí jde opravdu vidět že Milan
                strůjce svých receptů opravdu ví co dělá. S klukama z Tactics je
                super spolupráce, co řeknou to platí a nic se nemění. Proto moje
                další verze V3. - mých{" "}
                <a
                ...
                - budou vyrábět právě oni. V celém sortimentu naleznete - 1kg a
                3kg balení „krmných koulí“ , chytací koule v jejich stylu
                „Silent hunter“, obalované pop-up, obalovací těsto, booster a
                další…
              </p>
              <p className="my-5">
                Zakoupení těchto výrobků mě osobně podpoříš v tom co rád dělám a
                to je točení videjí na mém{" "}
                <a
                  href="https://www.youtube.com/@RybarenisKubakem"
                  className="font-bold hover:text-[#FFD369]"
                >
                ...
                a hlavně můžeš chytat na kvalitní koule co jsem dal dohromady s{" "}
                <a
                  href="https://www.tactics.cz/"
                  className="font-bold hover:text-[#FFD369]"
                >

                ...
                <div className="sm:text-center pb-8 pl-4 md:hidden">
                  ...
                  <div className="grid md:grid-cols-3 gap-2 border-4 rounded-2xl p-5 text-justify my-5">
                    <div className="col-span-2 flex flex-col justify-center md:text-right 2xl:text-lg">
                      ...
                      <p className="text-justify my-5 mr-4">
                        Pokud si nevíš rady a chceš pomoct s výběrem vybavení,
                        mám pro Tebe pár typů. Společně to zvládneme.
                      </p>
                    </div>
                    <div className="flex justify-center items-center">
                      <img
                ...
                <div className="h-auto px-5">
                  ...
                  <div className="border-4 rounded-2xl p-5 text-justify">
                    ...
                    <p className="my-5">
                      ...
                      narazil poprvé na jejich stánku. Nejdříve mě zajímal
                      ...
                      , které se mi hodně líbilo jsem po několika měsících
                      zvážil spolupráci právě s touto značkou. Jsem spokojený s
                      jejich výrobky jak fungují ve vodě a hlavně mi vyhovují
                    ...
                    <p className="my-5">
                      ...
                      Milan strůjce svých receptů opravdu ví co dělá. S klukama
                      z Tactics je super spolupráce, co řeknou to platí a nic se
                  ...
                  <div className="h-auto px-5">
                    ...
                    <div className="border-4 rounded-2xl p-5 text-justify">
                      ...
                      <p className="my-5">
                        ...
                        , které se mi hodně líbilo jsem po několika měsících
                        zvážil spolupráci právě s touto značkou. Jsem spokojený
                        s jejich výrobky jak fungují ve vodě a hlavně mi
                        vyhovují jejich produkty jako takové. Na{" "}
                        <a
                          href="https://www.tactics.cz/stitek-produktu/cervene-ovoce/"
                          className="font-bold hover:text-[#FFD369] link--resized"
                        >
                        ...
                        se mi povedlo pár krásných ryb jak jste mohli vidět v
                        mých videích na mém{" "}
                        <a
                          href="https://www.youtube.com/@RybarenisKubakem"
                          className="font-bold hover:text-[#FFD369] link--resized"
                      ...
                      <p className="my-5">
                        Po měsících testování a zkoušení se mi opravdu líbí
                        jejich přístup jak jejich produkty vyrábějí jde opravdu
                        vidět že Milan strůjce svých receptů opravdu ví co dělá.
                        S klukama z Tactics je super spolupráce, co řeknou to
                        platí a nic se nemění. Proto moje další verze V3. - mých{" "}
                        <a
                          href="https://www.tactics.cz/kubakuv-program/"
                          className="font-bold hover:text-[#FFD369] border-b-2 border-[#FFD369] link--resized"
                        >
                        ...
                        - budou vyrábět právě oni. V celém sortimentu naleznete
                        - 1kg a 3kg balení „krmných koulí“ , chytací koule v
                        jejich stylu „Silent hunter“, obalované pop-up,
                        obalovací těsto, booster a další…
                      </p>
                      <p className="my-5">
                        Zakoupení těchto výrobků mě osobně podpoříš v tom co rád
                        dělám a to je točení videjí na mém{" "}
                  ...
                  <Fade left>
                    <div className="grid md:grid-cols-3 gap-2 border-4 rounded-2xl p-5 text-justify">
                      <div className="col-span-2 flex flex-col justify-center md:text-right 2xl:text-lg">
                        <h3 className="font-bold text-left">WORKSHOP</h3>
                        <p className="text-justify my-5 mr-4">
                          Pokud chceš společně semnou vyrazit na ryby, máš
                          možnost rezervovat termín, případně zakoupit dárkový
                          poukaz kamarádovi.
                        </p>
                      </div>
                      <div className="hidden md:flex justify-center items-center">
